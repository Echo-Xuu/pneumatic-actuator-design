...
def make_selections(volumetric_mesh_fname, CX_fname, UT_fname):
    ...
    with open("volume_selections.txt", "w") as file_:
        ...
        w2 = igl.winding_number(UT.points.astype(np.double), UT.cells_dict["triangle"], tet_barycenters)
...
if __name__ == "__main__":
    make_selections("LORIP45V1_UTCX_CD_UD1.msh", "LORIP45V1_CX_CD_UD1.STL", "LORIP45V1_UT_CD_UD1.STL")
